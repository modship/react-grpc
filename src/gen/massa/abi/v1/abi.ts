...
class CreateScRequest$Type extends MessageType<CreateScRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateScRequest): CreateScRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CreateScRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes bytecode = 1; */
...
class CreateScResult$Type extends MessageType<CreateScResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateScResult): CreateScResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CreateScResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string sc_address = 1; */
...
class CallRequest$Type extends MessageType<CallRequest> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* massa.model.v1.NativeAmount call_coins */ 4:
                    message.callCoins = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.callCoins);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CallRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetFunctionName !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.targetFunctionName);
        ...
        if (message.callCoins)
            NativeAmount.internalBinaryWrite(message.callCoins, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class LocalExecutionRequest$Type extends MessageType<LocalExecutionRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LocalExecutionRequest): LocalExecutionRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: LocalExecutionRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes bytecode = 1; */
        if (message.bytecode.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.bytecode);
        /* string target_function_name = 2; */
...
class LocalExecutionResponse$Type extends MessageType<LocalExecutionResponse> {
    ...
    create(value?: PartialMessage<LocalExecutionResponse>): LocalExecutionResponse {
        const message = { data: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LocalExecutionResponse): LocalExecutionResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: LocalExecutionResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes data = 1; */
        if (message.data.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.data);
        let u = options.writeUnknownFields;
...
class GenerateEventRequest$Type extends MessageType<GenerateEventRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GenerateEventRequest): GenerateEventRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GenerateEventRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes event = 1; */
...
class GenerateEventResult$Type extends MessageType<GenerateEventResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GenerateEventResult): GenerateEventResult {
        return target ?? this.create();
    }
    internalBinaryWrite(message: GenerateEventResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class TransferCoinsRequest$Type extends MessageType<TransferCoinsRequest> {
    constructor() {
        super("massa.abi.v1.TransferCoinsRequest", [
            ...
            { no: 2, name: "amount_to_transfer", kind: "message", T: () => NativeAmount },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TransferCoinsRequest): TransferCoinsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* massa.model.v1.NativeAmount amount_to_transfer */ 2:
                    message.amountToTransfer = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.amountToTransfer);
                    break;
                case /* optional google.protobuf.StringValue sender_address */ 3:
                    message.senderAddress = StringValue.internalBinaryRead(reader, reader.uint32(), options, message.senderAddress);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: TransferCoinsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.amountToTransfer)
            NativeAmount.internalBinaryWrite(message.amountToTransfer, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* optional google.protobuf.StringValue sender_address = 3; */
        if (message.senderAddress)
            StringValue.internalBinaryWrite(message.senderAddress, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class TransferCoinsResult$Type extends MessageType<TransferCoinsResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TransferCoinsResult): TransferCoinsResult {
        return target ?? this.create();
    }
    internalBinaryWrite(message: TransferCoinsResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class FunctionExistsRequest$Type extends MessageType<FunctionExistsRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FunctionExistsRequest): FunctionExistsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: FunctionExistsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string target_sc_address = 1; */
        if (message.targetScAddress !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.targetScAddress);
...
class FunctionExistsResult$Type extends MessageType<FunctionExistsResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FunctionExistsResult): FunctionExistsResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: FunctionExistsResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool exists = 1; */
...
class RespResult$Type extends MessageType<RespResult> {
    constructor() {
        super("massa.abi.v1.RespResult", [
            { no: 1, name: "add_native_amount_result", kind: "message", oneof: "res", T: () => AddNativeAmountResult },
            { no: 2, name: "address_from_pub_key_result", kind: "message", oneof: "res", T: () => AddressFromPubKeyResult },
            { no: 3, name: "append_ds_value_result", kind: "message", oneof: "res", T: () => AppendDsValueResult },
            { no: 4, name: "base58_check_to_bytes_result", kind: "message", oneof: "res", T: () => Base58CheckToBytesResult },
            { no: 5, name: "bytes_to_base58_check_result", kind: "message", oneof: "res", T: () => BytesToBase58CheckResult },
            { no: 6, name: "caller_has_write_access_result", kind: "message", oneof: "res", T: () => CallerHasWriteAccessResult },
            { no: 7, name: "check_address_result", kind: "message", oneof: "res", T: () => CheckAddressResult },
            { no: 8, name: "check_native_amount_result", kind: "message", oneof: "res", T: () => CheckNativeAmountResult },
            { no: 9, name: "check_pub_key_result", kind: "message", oneof: "res", T: () => CheckPubKeyResult },
            { no: 10, name: "check_sig_result", kind: "message", oneof: "res", T: () => CheckSigResult },
            { no: 11, name: "checked_add_native_time_result", kind: "message", oneof: "res", T: () => CheckedAddNativeTimeResult },
            { no: 12, name: "checked_div_rem_native_time_result", kind: "message", oneof: "res", T: () => CheckedDivRemNativeTimeResult },
            { no: 13, name: "checked_scalar_div_rem_native_time_result", kind: "message", oneof: "res", T: () => CheckedScalarDivRemNativeTimeResult },
            { no: 14, name: "checked_scalar_mul_native_time_result", kind: "message", oneof: "res", T: () => CheckedScalarMulNativeTimeResult },
            { no: 15, name: "checked_sub_native_time_result", kind: "message", oneof: "res", T: () => CheckedSubNativeTimeResult },
            { no: 16, name: "compare_address_result", kind: "message", oneof: "res", T: () => CompareAddressResult },
            { no: 17, name: "compare_native_amount_result", kind: "message", oneof: "res", T: () => CompareNativeAmountResult },
            { no: 18, name: "compare_native_time_result", kind: "message", oneof: "res", T: () => CompareNativeTimeResult },
            { no: 19, name: "compare_pub_key_result", kind: "message", oneof: "res", T: () => ComparePubKeyResult },
            { no: 20, name: "create_sc_result", kind: "message", oneof: "res", T: () => CreateScResult },
            { no: 21, name: "delete_ds_entry_result", kind: "message", oneof: "res", T: () => DeleteDsEntryResult },
            { no: 22, name: "div_rem_native_amount_result", kind: "message", oneof: "res", T: () => DivRemNativeAmountResult },
            { no: 23, name: "ds_entry_exists_result", kind: "message", oneof: "res", T: () => DsEntryExistsResult },
            { no: 24, name: "function_exists_result", kind: "message", oneof: "res", T: () => FunctionExistsResult },
            { no: 25, name: "generate_event_result", kind: "message", oneof: "res", T: () => GenerateEventResult },
            { no: 26, name: "get_address_category_result", kind: "message", oneof: "res", T: () => GetAddressCategoryResult },
            { no: 27, name: "get_address_version_result", kind: "message", oneof: "res", T: () => GetAddressVersionResult },
            { no: 28, name: "get_balance_result", kind: "message", oneof: "res", T: () => GetBalanceResult },
            { no: 29, name: "get_bytecode_result", kind: "message", oneof: "res", T: () => GetBytecodeResult },
            { no: 30, name: "get_call_coins_result", kind: "message", oneof: "res", T: () => GetCallCoinsResult },
            { no: 31, name: "get_call_stack_result", kind: "message", oneof: "res", T: () => GetCallStackResult },
            { no: 32, name: "get_current_slot_result", kind: "message", oneof: "res", T: () => GetCurrentSlotResult },
            { no: 33, name: "get_ds_keys_result", kind: "message", oneof: "res", T: () => GetDsKeysResult },
            { no: 34, name: "get_ds_value_result", kind: "message", oneof: "res", T: () => GetDsValueResult },
            { no: 35, name: "get_native_time_result", kind: "message", oneof: "res", T: () => GetNativeTimeResult },
            { no: 36, name: "get_op_data_result", kind: "message", oneof: "res", T: () => GetOpDataResult },
            { no: 37, name: "get_op_keys_result", kind: "message", oneof: "res", T: () => GetOpKeysResult },
            { no: 38, name: "get_origin_operation_id_result", kind: "message", oneof: "res", T: () => GetOriginOperationIdResult },
            { no: 39, name: "get_owned_addresses_result", kind: "message", oneof: "res", T: () => GetOwnedAddressesResult },
            { no: 40, name: "get_pub_key_version_result", kind: "message", oneof: "res", T: () => GetPubKeyVersionResult },
            { no: 41, name: "get_remaining_gas_result", kind: "message", oneof: "res", T: () => GetRemainingGasResult },
            { no: 42, name: "get_signature_version_result", kind: "message", oneof: "res", T: () => GetSignatureVersionResult },
            { no: 43, name: "hash_blake3_result", kind: "message", oneof: "res", T: () => HashBlake3Result },
            { no: 44, name: "hash_sha256_result", kind: "message", oneof: "res", T: () => HashSha256Result },
            { no: 45, name: "op_entry_exists_result", kind: "message", oneof: "res", T: () => OpEntryExistsResult },
            { no: 46, name: "keccak256_result", kind: "message", oneof: "res", T: () => Keccak256Result },
            { no: 47, name: "local_execution_response", kind: "message", oneof: "res", T: () => LocalExecutionResponse },
            { no: 48, name: "native_amount_from_string_result", kind: "message", oneof: "res", T: () => NativeAmountFromStringResult },
            { no: 49, name: "native_amount_to_string_result", kind: "message", oneof: "res", T: () => NativeAmountToStringResult },
            { no: 50, name: "scalar_div_rem_native_amount_result", kind: "message", oneof: "res", T: () => ScalarDivRemNativeAmountResult },
            { no: 51, name: "scalar_mul_native_amount_result", kind: "message", oneof: "res", T: () => ScalarMulNativeAmountResult },
            { no: 52, name: "send_async_message_result", kind: "message", oneof: "res", T: () => SendAsyncMessageResult },
            { no: 53, name: "set_bytecode_result", kind: "message", oneof: "res", T: () => SetBytecodeResult },
            { no: 54, name: "set_ds_value_result", kind: "message", oneof: "res", T: () => SetDsValueResult },
            { no: 55, name: "sub_native_amount_result", kind: "message", oneof: "res", T: () => SubNativeAmountResult },
            { no: 56, name: "transfer_coins_result", kind: "message", oneof: "res", T: () => TransferCoinsResult },
            { no: 57, name: "unsafe_random_result", kind: "message", oneof: "res", T: () => UnsafeRandomResult },
            { no: 58, name: "evm_verify_sig_result", kind: "message", oneof: "res", T: () => EvmVerifySigResult },
            { no: 59, name: "verify_sig_result", kind: "message", oneof: "res", T: () => VerifySigResult },
            { no: 60, name: "evm_get_address_from_pubkey_result", kind: "message", oneof: "res", T: () => EvmGetAddressFromPubkeyResult },
            { no: 61, name: "evm_get_pubkey_from_signature_result", kind: "message", oneof: "res", T: () => EvmGetPubkeyFromSignatureResult },
            { no: 62, name: "is_address_eoa_result", kind: "message", oneof: "res", T: () => IsAddressEoaResult }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RespResult): RespResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.abi.v1.AddNativeAmountResult add_native_amount_result */ 1:
                    message.res = {
                        oneofKind: "addNativeAmountResult",
                        addNativeAmountResult: AddNativeAmountResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).addNativeAmountResult)
                    };
                    break;
                case /* massa.abi.v1.AddressFromPubKeyResult address_from_pub_key_result */ 2:
                    message.res = {
                        oneofKind: "addressFromPubKeyResult",
                        addressFromPubKeyResult: AddressFromPubKeyResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).addressFromPubKeyResult)
                    };
                    break;
                case /* massa.abi.v1.AppendDsValueResult append_ds_value_result */ 3:
                    message.res = {
                        oneofKind: "appendDsValueResult",
                        appendDsValueResult: AppendDsValueResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).appendDsValueResult)
                    };
                    break;
                case /* massa.abi.v1.Base58CheckToBytesResult base58_check_to_bytes_result */ 4:
                    message.res = {
                        oneofKind: "base58CheckToBytesResult",
                        base58CheckToBytesResult: Base58CheckToBytesResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).base58CheckToBytesResult)
                    };
                    break;
                case /* massa.abi.v1.BytesToBase58CheckResult bytes_to_base58_check_result */ 5:
                    message.res = {
                        oneofKind: "bytesToBase58CheckResult",
                        bytesToBase58CheckResult: BytesToBase58CheckResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).bytesToBase58CheckResult)
                    };
                    break;
                case /* massa.abi.v1.CallerHasWriteAccessResult caller_has_write_access_result */ 6:
                    message.res = {
                        oneofKind: "callerHasWriteAccessResult",
                        callerHasWriteAccessResult: CallerHasWriteAccessResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).callerHasWriteAccessResult)
                    };
                    break;
                case /* massa.abi.v1.CheckAddressResult check_address_result */ 7:
                    message.res = {
                        oneofKind: "checkAddressResult",
                        checkAddressResult: CheckAddressResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkAddressResult)
                    };
                    break;
                case /* massa.abi.v1.CheckNativeAmountResult check_native_amount_result */ 8:
                    message.res = {
                        oneofKind: "checkNativeAmountResult",
                        checkNativeAmountResult: CheckNativeAmountResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkNativeAmountResult)
                    };
                    break;
                case /* massa.abi.v1.CheckPubKeyResult check_pub_key_result */ 9:
                    message.res = {
                        oneofKind: "checkPubKeyResult",
                        checkPubKeyResult: CheckPubKeyResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkPubKeyResult)
                    };
                    break;
                case /* massa.abi.v1.CheckSigResult check_sig_result */ 10:
                    message.res = {
                        oneofKind: "checkSigResult",
                        checkSigResult: CheckSigResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkSigResult)
                    };
                    break;
                case /* massa.abi.v1.CheckedAddNativeTimeResult checked_add_native_time_result */ 11:
                    message.res = {
                        oneofKind: "checkedAddNativeTimeResult",
                        checkedAddNativeTimeResult: CheckedAddNativeTimeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkedAddNativeTimeResult)
                    };
                    break;
                case /* massa.abi.v1.CheckedDivRemNativeTimeResult checked_div_rem_native_time_result */ 12:
                    message.res = {
                        oneofKind: "checkedDivRemNativeTimeResult",
                        checkedDivRemNativeTimeResult: CheckedDivRemNativeTimeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkedDivRemNativeTimeResult)
                    };
                    break;
                case /* massa.abi.v1.CheckedScalarDivRemNativeTimeResult checked_scalar_div_rem_native_time_result */ 13:
                    message.res = {
                        oneofKind: "checkedScalarDivRemNativeTimeResult",
                        checkedScalarDivRemNativeTimeResult: CheckedScalarDivRemNativeTimeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkedScalarDivRemNativeTimeResult)
                    };
                    break;
                case /* massa.abi.v1.CheckedScalarMulNativeTimeResult checked_scalar_mul_native_time_result */ 14:
                    message.res = {
                        oneofKind: "checkedScalarMulNativeTimeResult",
                        checkedScalarMulNativeTimeResult: CheckedScalarMulNativeTimeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkedScalarMulNativeTimeResult)
                    };
                    break;
                case /* massa.abi.v1.CheckedSubNativeTimeResult checked_sub_native_time_result */ 15:
                    message.res = {
                        oneofKind: "checkedSubNativeTimeResult",
                        checkedSubNativeTimeResult: CheckedSubNativeTimeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).checkedSubNativeTimeResult)
                    };
                    break;
                case /* massa.abi.v1.CompareAddressResult compare_address_result */ 16:
                    message.res = {
                        oneofKind: "compareAddressResult",
                        compareAddressResult: CompareAddressResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).compareAddressResult)
                    };
                    break;
                case /* massa.abi.v1.CompareNativeAmountResult compare_native_amount_result */ 17:
                    message.res = {
                        oneofKind: "compareNativeAmountResult",
                        compareNativeAmountResult: CompareNativeAmountResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).compareNativeAmountResult)
                    };
                    break;
                case /* massa.abi.v1.CompareNativeTimeResult compare_native_time_result */ 18:
                    message.res = {
                        oneofKind: "compareNativeTimeResult",
                        compareNativeTimeResult: CompareNativeTimeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).compareNativeTimeResult)
                    };
                    break;
                case /* massa.abi.v1.ComparePubKeyResult compare_pub_key_result */ 19:
                    message.res = {
                        oneofKind: "comparePubKeyResult",
                        comparePubKeyResult: ComparePubKeyResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).comparePubKeyResult)
                    };
                    break;
                case /* massa.abi.v1.CreateScResult create_sc_result */ 20:
                    message.res = {
                        oneofKind: "createScResult",
                        createScResult: CreateScResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).createScResult)
                    };
                    break;
                case /* massa.abi.v1.DeleteDsEntryResult delete_ds_entry_result */ 21:
                    message.res = {
                        oneofKind: "deleteDsEntryResult",
                        deleteDsEntryResult: DeleteDsEntryResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).deleteDsEntryResult)
                    };
                    break;
                case /* massa.abi.v1.DivRemNativeAmountResult div_rem_native_amount_result */ 22:
                    message.res = {
                        oneofKind: "divRemNativeAmountResult",
                        divRemNativeAmountResult: DivRemNativeAmountResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).divRemNativeAmountResult)
                    };
                    break;
                case /* massa.abi.v1.DsEntryExistsResult ds_entry_exists_result */ 23:
                    message.res = {
                        oneofKind: "dsEntryExistsResult",
                        dsEntryExistsResult: DsEntryExistsResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).dsEntryExistsResult)
                    };
                    break;
                case /* massa.abi.v1.FunctionExistsResult function_exists_result */ 24:
                    message.res = {
                        oneofKind: "functionExistsResult",
                        functionExistsResult: FunctionExistsResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).functionExistsResult)
                    };
                    break;
                case /* massa.abi.v1.GenerateEventResult generate_event_result */ 25:
                    message.res = {
                        oneofKind: "generateEventResult",
                        generateEventResult: GenerateEventResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).generateEventResult)
                    };
                    break;
                case /* massa.abi.v1.GetAddressCategoryResult get_address_category_result */ 26:
                    message.res = {
                        oneofKind: "getAddressCategoryResult",
                        getAddressCategoryResult: GetAddressCategoryResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getAddressCategoryResult)
                    };
                    break;
                case /* massa.abi.v1.GetAddressVersionResult get_address_version_result */ 27:
                    message.res = {
                        oneofKind: "getAddressVersionResult",
                        getAddressVersionResult: GetAddressVersionResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getAddressVersionResult)
                    };
                    break;
                case /* massa.abi.v1.GetBalanceResult get_balance_result */ 28:
                    message.res = {
                        oneofKind: "getBalanceResult",
                        getBalanceResult: GetBalanceResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getBalanceResult)
                    };
                    break;
                case /* massa.abi.v1.GetBytecodeResult get_bytecode_result */ 29:
                    message.res = {
                        oneofKind: "getBytecodeResult",
                        getBytecodeResult: GetBytecodeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getBytecodeResult)
                    };
                    break;
                case /* massa.abi.v1.GetCallCoinsResult get_call_coins_result */ 30:
                    message.res = {
                        oneofKind: "getCallCoinsResult",
                        getCallCoinsResult: GetCallCoinsResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getCallCoinsResult)
                    };
                    break;
                case /* massa.abi.v1.GetCallStackResult get_call_stack_result */ 31:
                    message.res = {
                        oneofKind: "getCallStackResult",
                        getCallStackResult: GetCallStackResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getCallStackResult)
                    };
                    break;
                case /* massa.abi.v1.GetCurrentSlotResult get_current_slot_result */ 32:
                    message.res = {
                        oneofKind: "getCurrentSlotResult",
                        getCurrentSlotResult: GetCurrentSlotResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getCurrentSlotResult)
                    };
                    break;
                case /* massa.abi.v1.GetDsKeysResult get_ds_keys_result */ 33:
                    message.res = {
                        oneofKind: "getDsKeysResult",
                        getDsKeysResult: GetDsKeysResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getDsKeysResult)
                    };
                    break;
                case /* massa.abi.v1.GetDsValueResult get_ds_value_result */ 34:
                    message.res = {
                        oneofKind: "getDsValueResult",
                        getDsValueResult: GetDsValueResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getDsValueResult)
                    };
                    break;
                case /* massa.abi.v1.GetNativeTimeResult get_native_time_result */ 35:
                    message.res = {
                        oneofKind: "getNativeTimeResult",
                        getNativeTimeResult: GetNativeTimeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getNativeTimeResult)
                    };
                    break;
                case /* massa.abi.v1.GetOpDataResult get_op_data_result */ 36:
                    message.res = {
                        oneofKind: "getOpDataResult",
                        getOpDataResult: GetOpDataResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getOpDataResult)
                    };
                    break;
                case /* massa.abi.v1.GetOpKeysResult get_op_keys_result */ 37:
                    message.res = {
                        oneofKind: "getOpKeysResult",
                        getOpKeysResult: GetOpKeysResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getOpKeysResult)
                    };
                    break;
                case /* massa.abi.v1.GetOriginOperationIdResult get_origin_operation_id_result */ 38:
                    message.res = {
                        oneofKind: "getOriginOperationIdResult",
                        getOriginOperationIdResult: GetOriginOperationIdResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getOriginOperationIdResult)
                    };
                    break;
                case /* massa.abi.v1.GetOwnedAddressesResult get_owned_addresses_result */ 39:
                    message.res = {
                        oneofKind: "getOwnedAddressesResult",
                        getOwnedAddressesResult: GetOwnedAddressesResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getOwnedAddressesResult)
                    };
                    break;
                case /* massa.abi.v1.GetPubKeyVersionResult get_pub_key_version_result */ 40:
                    message.res = {
                        oneofKind: "getPubKeyVersionResult",
                        getPubKeyVersionResult: GetPubKeyVersionResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getPubKeyVersionResult)
                    };
                    break;
                case /* massa.abi.v1.GetRemainingGasResult get_remaining_gas_result */ 41:
                    message.res = {
                        oneofKind: "getRemainingGasResult",
                        getRemainingGasResult: GetRemainingGasResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getRemainingGasResult)
                    };
                    break;
                case /* massa.abi.v1.GetSignatureVersionResult get_signature_version_result */ 42:
                    message.res = {
                        oneofKind: "getSignatureVersionResult",
                        getSignatureVersionResult: GetSignatureVersionResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).getSignatureVersionResult)
                    };
                    break;
                case /* massa.abi.v1.HashBlake3Result hash_blake3_result */ 43:
                    message.res = {
                        oneofKind: "hashBlake3Result",
                        hashBlake3Result: HashBlake3Result.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).hashBlake3Result)
                    };
                    break;
                case /* massa.abi.v1.HashSha256Result hash_sha256_result */ 44:
                    message.res = {
                        oneofKind: "hashSha256Result",
                        hashSha256Result: HashSha256Result.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).hashSha256Result)
                    };
                    break;
                case /* massa.abi.v1.OpEntryExistsResult op_entry_exists_result */ 45:
                    message.res = {
                        oneofKind: "opEntryExistsResult",
                        opEntryExistsResult: OpEntryExistsResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).opEntryExistsResult)
                    };
                    break;
                case /* massa.abi.v1.Keccak256Result keccak256_result */ 46:
                    message.res = {
                        oneofKind: "keccak256Result",
                        keccak256Result: Keccak256Result.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).keccak256Result)
                    };
                    break;
                case /* massa.abi.v1.LocalExecutionResponse local_execution_response */ 47:
                    message.res = {
                        oneofKind: "localExecutionResponse",
                        localExecutionResponse: LocalExecutionResponse.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).localExecutionResponse)
                    };
                    break;
                case /* massa.abi.v1.NativeAmountFromStringResult native_amount_from_string_result */ 48:
                    message.res = {
                        oneofKind: "nativeAmountFromStringResult",
                        nativeAmountFromStringResult: NativeAmountFromStringResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).nativeAmountFromStringResult)
                    };
                    break;
                case /* massa.abi.v1.NativeAmountToStringResult native_amount_to_string_result */ 49:
                    message.res = {
                        oneofKind: "nativeAmountToStringResult",
                        nativeAmountToStringResult: NativeAmountToStringResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).nativeAmountToStringResult)
                    };
                    break;
                case /* massa.abi.v1.ScalarDivRemNativeAmountResult scalar_div_rem_native_amount_result */ 50:
                    message.res = {
                        oneofKind: "scalarDivRemNativeAmountResult",
                        scalarDivRemNativeAmountResult: ScalarDivRemNativeAmountResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).scalarDivRemNativeAmountResult)
                    };
                    break;
                case /* massa.abi.v1.ScalarMulNativeAmountResult scalar_mul_native_amount_result */ 51:
                    message.res = {
                        oneofKind: "scalarMulNativeAmountResult",
                        scalarMulNativeAmountResult: ScalarMulNativeAmountResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).scalarMulNativeAmountResult)
                    };
                    break;
                case /* massa.abi.v1.SendAsyncMessageResult send_async_message_result */ 52:
                    message.res = {
                        oneofKind: "sendAsyncMessageResult",
                        sendAsyncMessageResult: SendAsyncMessageResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).sendAsyncMessageResult)
                    };
                    break;
                case /* massa.abi.v1.SetBytecodeResult set_bytecode_result */ 53:
                    message.res = {
                        oneofKind: "setBytecodeResult",
                        setBytecodeResult: SetBytecodeResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).setBytecodeResult)
                    };
                    break;
                case /* massa.abi.v1.SetDsValueResult set_ds_value_result */ 54:
                    message.res = {
                        oneofKind: "setDsValueResult",
                        setDsValueResult: SetDsValueResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).setDsValueResult)
                    };
                    break;
                case /* massa.abi.v1.SubNativeAmountResult sub_native_amount_result */ 55:
                    message.res = {
                        oneofKind: "subNativeAmountResult",
                        subNativeAmountResult: SubNativeAmountResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).subNativeAmountResult)
                    };
                    break;
                case /* massa.abi.v1.TransferCoinsResult transfer_coins_result */ 56:
                    message.res = {
                        oneofKind: "transferCoinsResult",
                        transferCoinsResult: TransferCoinsResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).transferCoinsResult)
                    };
                    break;
                case /* massa.abi.v1.UnsafeRandomResult unsafe_random_result */ 57:
                    message.res = {
                        oneofKind: "unsafeRandomResult",
                        unsafeRandomResult: UnsafeRandomResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).unsafeRandomResult)
                    };
                    break;
                case /* massa.abi.v1.EvmVerifySigResult evm_verify_sig_result */ 58:
                    message.res = {
                        oneofKind: "evmVerifySigResult",
                        evmVerifySigResult: EvmVerifySigResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).evmVerifySigResult)
                    };
                    break;
                case /* massa.abi.v1.VerifySigResult verify_sig_result */ 59:
                    message.res = {
                        oneofKind: "verifySigResult",
                        verifySigResult: VerifySigResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).verifySigResult)
                    };
                    break;
                case /* massa.abi.v1.EvmGetAddressFromPubkeyResult evm_get_address_from_pubkey_result */ 60:
                    message.res = {
                        oneofKind: "evmGetAddressFromPubkeyResult",
                        evmGetAddressFromPubkeyResult: EvmGetAddressFromPubkeyResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).evmGetAddressFromPubkeyResult)
                    };
                    break;
                case /* massa.abi.v1.EvmGetPubkeyFromSignatureResult evm_get_pubkey_from_signature_result */ 61:
                    message.res = {
                        oneofKind: "evmGetPubkeyFromSignatureResult",
                        evmGetPubkeyFromSignatureResult: EvmGetPubkeyFromSignatureResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).evmGetPubkeyFromSignatureResult)
                    };
                    break;
                case /* massa.abi.v1.IsAddressEoaResult is_address_eoa_result */ 62:
                    message.res = {
                        oneofKind: "isAddressEoaResult",
                        isAddressEoaResult: IsAddressEoaResult.internalBinaryRead(reader, reader.uint32(), options, (message.res as any).isAddressEoaResult)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: RespResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.abi.v1.AddNativeAmountResult add_native_amount_result = 1; */
        if (message.res.oneofKind === "addNativeAmountResult")
            AddNativeAmountResult.internalBinaryWrite(message.res.addNativeAmountResult, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.AddressFromPubKeyResult address_from_pub_key_result = 2; */
        if (message.res.oneofKind === "addressFromPubKeyResult")
            AddressFromPubKeyResult.internalBinaryWrite(message.res.addressFromPubKeyResult, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.AppendDsValueResult append_ds_value_result = 3; */
        if (message.res.oneofKind === "appendDsValueResult")
            AppendDsValueResult.internalBinaryWrite(message.res.appendDsValueResult, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.Base58CheckToBytesResult base58_check_to_bytes_result = 4; */
        if (message.res.oneofKind === "base58CheckToBytesResult")
            Base58CheckToBytesResult.internalBinaryWrite(message.res.base58CheckToBytesResult, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.BytesToBase58CheckResult bytes_to_base58_check_result = 5; */
        if (message.res.oneofKind === "bytesToBase58CheckResult")
            BytesToBase58CheckResult.internalBinaryWrite(message.res.bytesToBase58CheckResult, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "callerHasWriteAccessResult")
            CallerHasWriteAccessResult.internalBinaryWrite(message.res.callerHasWriteAccessResult, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.CheckAddressResult check_address_result = 7; */
        if (message.res.oneofKind === "checkAddressResult")
            CheckAddressResult.internalBinaryWrite(message.res.checkAddressResult, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.CheckNativeAmountResult check_native_amount_result = 8; */
        if (message.res.oneofKind === "checkNativeAmountResult")
            CheckNativeAmountResult.internalBinaryWrite(message.res.checkNativeAmountResult, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.CheckPubKeyResult check_pub_key_result = 9; */
        if (message.res.oneofKind === "checkPubKeyResult")
            CheckPubKeyResult.internalBinaryWrite(message.res.checkPubKeyResult, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.CheckSigResult check_sig_result = 10; */
        if (message.res.oneofKind === "checkSigResult")
            CheckSigResult.internalBinaryWrite(message.res.checkSigResult, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "checkedAddNativeTimeResult")
            CheckedAddNativeTimeResult.internalBinaryWrite(message.res.checkedAddNativeTimeResult, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "checkedDivRemNativeTimeResult")
            CheckedDivRemNativeTimeResult.internalBinaryWrite(message.res.checkedDivRemNativeTimeResult, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "checkedScalarDivRemNativeTimeResult")
            CheckedScalarDivRemNativeTimeResult.internalBinaryWrite(message.res.checkedScalarDivRemNativeTimeResult, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "checkedScalarMulNativeTimeResult")
            CheckedScalarMulNativeTimeResult.internalBinaryWrite(message.res.checkedScalarMulNativeTimeResult, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "checkedSubNativeTimeResult")
            CheckedSubNativeTimeResult.internalBinaryWrite(message.res.checkedSubNativeTimeResult, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.CompareAddressResult compare_address_result = 16; */
        if (message.res.oneofKind === "compareAddressResult")
            CompareAddressResult.internalBinaryWrite(message.res.compareAddressResult, writer.tag(16, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.CompareNativeAmountResult compare_native_amount_result = 17; */
        if (message.res.oneofKind === "compareNativeAmountResult")
            CompareNativeAmountResult.internalBinaryWrite(message.res.compareNativeAmountResult, writer.tag(17, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.CompareNativeTimeResult compare_native_time_result = 18; */
        if (message.res.oneofKind === "compareNativeTimeResult")
            CompareNativeTimeResult.internalBinaryWrite(message.res.compareNativeTimeResult, writer.tag(18, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.ComparePubKeyResult compare_pub_key_result = 19; */
        if (message.res.oneofKind === "comparePubKeyResult")
            ComparePubKeyResult.internalBinaryWrite(message.res.comparePubKeyResult, writer.tag(19, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.CreateScResult create_sc_result = 20; */
        if (message.res.oneofKind === "createScResult")
            CreateScResult.internalBinaryWrite(message.res.createScResult, writer.tag(20, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.DeleteDsEntryResult delete_ds_entry_result = 21; */
        if (message.res.oneofKind === "deleteDsEntryResult")
            DeleteDsEntryResult.internalBinaryWrite(message.res.deleteDsEntryResult, writer.tag(21, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.DivRemNativeAmountResult div_rem_native_amount_result = 22; */
        if (message.res.oneofKind === "divRemNativeAmountResult")
            DivRemNativeAmountResult.internalBinaryWrite(message.res.divRemNativeAmountResult, writer.tag(22, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.DsEntryExistsResult ds_entry_exists_result = 23; */
        if (message.res.oneofKind === "dsEntryExistsResult")
            DsEntryExistsResult.internalBinaryWrite(message.res.dsEntryExistsResult, writer.tag(23, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.FunctionExistsResult function_exists_result = 24; */
        if (message.res.oneofKind === "functionExistsResult")
            FunctionExistsResult.internalBinaryWrite(message.res.functionExistsResult, writer.tag(24, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GenerateEventResult generate_event_result = 25; */
        if (message.res.oneofKind === "generateEventResult")
            GenerateEventResult.internalBinaryWrite(message.res.generateEventResult, writer.tag(25, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetAddressCategoryResult get_address_category_result = 26; */
        if (message.res.oneofKind === "getAddressCategoryResult")
            GetAddressCategoryResult.internalBinaryWrite(message.res.getAddressCategoryResult, writer.tag(26, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetAddressVersionResult get_address_version_result = 27; */
        if (message.res.oneofKind === "getAddressVersionResult")
            GetAddressVersionResult.internalBinaryWrite(message.res.getAddressVersionResult, writer.tag(27, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetBalanceResult get_balance_result = 28; */
        if (message.res.oneofKind === "getBalanceResult")
            GetBalanceResult.internalBinaryWrite(message.res.getBalanceResult, writer.tag(28, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetBytecodeResult get_bytecode_result = 29; */
        if (message.res.oneofKind === "getBytecodeResult")
            GetBytecodeResult.internalBinaryWrite(message.res.getBytecodeResult, writer.tag(29, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetCallCoinsResult get_call_coins_result = 30; */
        if (message.res.oneofKind === "getCallCoinsResult")
            GetCallCoinsResult.internalBinaryWrite(message.res.getCallCoinsResult, writer.tag(30, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetCallStackResult get_call_stack_result = 31; */
        if (message.res.oneofKind === "getCallStackResult")
            GetCallStackResult.internalBinaryWrite(message.res.getCallStackResult, writer.tag(31, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetCurrentSlotResult get_current_slot_result = 32; */
        if (message.res.oneofKind === "getCurrentSlotResult")
            GetCurrentSlotResult.internalBinaryWrite(message.res.getCurrentSlotResult, writer.tag(32, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetDsKeysResult get_ds_keys_result = 33; */
        if (message.res.oneofKind === "getDsKeysResult")
            GetDsKeysResult.internalBinaryWrite(message.res.getDsKeysResult, writer.tag(33, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetDsValueResult get_ds_value_result = 34; */
        if (message.res.oneofKind === "getDsValueResult")
            GetDsValueResult.internalBinaryWrite(message.res.getDsValueResult, writer.tag(34, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetNativeTimeResult get_native_time_result = 35; */
        if (message.res.oneofKind === "getNativeTimeResult")
            GetNativeTimeResult.internalBinaryWrite(message.res.getNativeTimeResult, writer.tag(35, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetOpDataResult get_op_data_result = 36; */
        if (message.res.oneofKind === "getOpDataResult")
            GetOpDataResult.internalBinaryWrite(message.res.getOpDataResult, writer.tag(36, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetOpKeysResult get_op_keys_result = 37; */
        if (message.res.oneofKind === "getOpKeysResult")
            GetOpKeysResult.internalBinaryWrite(message.res.getOpKeysResult, writer.tag(37, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "getOriginOperationIdResult")
            GetOriginOperationIdResult.internalBinaryWrite(message.res.getOriginOperationIdResult, writer.tag(38, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetOwnedAddressesResult get_owned_addresses_result = 39; */
        if (message.res.oneofKind === "getOwnedAddressesResult")
            GetOwnedAddressesResult.internalBinaryWrite(message.res.getOwnedAddressesResult, writer.tag(39, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetPubKeyVersionResult get_pub_key_version_result = 40; */
        if (message.res.oneofKind === "getPubKeyVersionResult")
            GetPubKeyVersionResult.internalBinaryWrite(message.res.getPubKeyVersionResult, writer.tag(40, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetRemainingGasResult get_remaining_gas_result = 41; */
        if (message.res.oneofKind === "getRemainingGasResult")
            GetRemainingGasResult.internalBinaryWrite(message.res.getRemainingGasResult, writer.tag(41, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.GetSignatureVersionResult get_signature_version_result = 42; */
        if (message.res.oneofKind === "getSignatureVersionResult")
            GetSignatureVersionResult.internalBinaryWrite(message.res.getSignatureVersionResult, writer.tag(42, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.HashBlake3Result hash_blake3_result = 43; */
        if (message.res.oneofKind === "hashBlake3Result")
            HashBlake3Result.internalBinaryWrite(message.res.hashBlake3Result, writer.tag(43, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.HashSha256Result hash_sha256_result = 44; */
        if (message.res.oneofKind === "hashSha256Result")
            HashSha256Result.internalBinaryWrite(message.res.hashSha256Result, writer.tag(44, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.OpEntryExistsResult op_entry_exists_result = 45; */
        if (message.res.oneofKind === "opEntryExistsResult")
            OpEntryExistsResult.internalBinaryWrite(message.res.opEntryExistsResult, writer.tag(45, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.Keccak256Result keccak256_result = 46; */
        if (message.res.oneofKind === "keccak256Result")
            Keccak256Result.internalBinaryWrite(message.res.keccak256Result, writer.tag(46, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.LocalExecutionResponse local_execution_response = 47; */
        if (message.res.oneofKind === "localExecutionResponse")
            LocalExecutionResponse.internalBinaryWrite(message.res.localExecutionResponse, writer.tag(47, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "nativeAmountFromStringResult")
            NativeAmountFromStringResult.internalBinaryWrite(message.res.nativeAmountFromStringResult, writer.tag(48, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "nativeAmountToStringResult")
            NativeAmountToStringResult.internalBinaryWrite(message.res.nativeAmountToStringResult, writer.tag(49, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "scalarDivRemNativeAmountResult")
            ScalarDivRemNativeAmountResult.internalBinaryWrite(message.res.scalarDivRemNativeAmountResult, writer.tag(50, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "scalarMulNativeAmountResult")
            ScalarMulNativeAmountResult.internalBinaryWrite(message.res.scalarMulNativeAmountResult, writer.tag(51, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.SendAsyncMessageResult send_async_message_result = 52; */
        if (message.res.oneofKind === "sendAsyncMessageResult")
            SendAsyncMessageResult.internalBinaryWrite(message.res.sendAsyncMessageResult, writer.tag(52, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.SetBytecodeResult set_bytecode_result = 53; */
        if (message.res.oneofKind === "setBytecodeResult")
            SetBytecodeResult.internalBinaryWrite(message.res.setBytecodeResult, writer.tag(53, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.SetDsValueResult set_ds_value_result = 54; */
        if (message.res.oneofKind === "setDsValueResult")
            SetDsValueResult.internalBinaryWrite(message.res.setDsValueResult, writer.tag(54, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.SubNativeAmountResult sub_native_amount_result = 55; */
        if (message.res.oneofKind === "subNativeAmountResult")
            SubNativeAmountResult.internalBinaryWrite(message.res.subNativeAmountResult, writer.tag(55, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.TransferCoinsResult transfer_coins_result = 56; */
        if (message.res.oneofKind === "transferCoinsResult")
            TransferCoinsResult.internalBinaryWrite(message.res.transferCoinsResult, writer.tag(56, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.UnsafeRandomResult unsafe_random_result = 57; */
        if (message.res.oneofKind === "unsafeRandomResult")
            UnsafeRandomResult.internalBinaryWrite(message.res.unsafeRandomResult, writer.tag(57, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.EvmVerifySigResult evm_verify_sig_result = 58; */
        if (message.res.oneofKind === "evmVerifySigResult")
            EvmVerifySigResult.internalBinaryWrite(message.res.evmVerifySigResult, writer.tag(58, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.VerifySigResult verify_sig_result = 59; */
        if (message.res.oneofKind === "verifySigResult")
            VerifySigResult.internalBinaryWrite(message.res.verifySigResult, writer.tag(59, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "evmGetAddressFromPubkeyResult")
            EvmGetAddressFromPubkeyResult.internalBinaryWrite(message.res.evmGetAddressFromPubkeyResult, writer.tag(60, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.res.oneofKind === "evmGetPubkeyFromSignatureResult")
            EvmGetPubkeyFromSignatureResult.internalBinaryWrite(message.res.evmGetPubkeyFromSignatureResult, writer.tag(61, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.IsAddressEoaResult is_address_eoa_result = 62; */
        if (message.res.oneofKind === "isAddressEoaResult")
            IsAddressEoaResult.internalBinaryWrite(message.res.isAddressEoaResult, writer.tag(62, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class AbiResponse$Type extends MessageType<AbiResponse> {
    constructor() {
        super("massa.abi.v1.AbiResponse", [
            { no: 1, name: "res", kind: "message", oneof: "resp", T: () => RespResult },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AbiResponse): AbiResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.abi.v1.RespResult res */ 1:
                    message.resp = {
                        oneofKind: "res",
                        res: RespResult.internalBinaryRead(reader, reader.uint32(), options, (message.resp as any).res)
                    };
                    break;
                case /* massa.abi.v1.Error error */ 2:
                    message.resp = {
                        oneofKind: "error",
                        error: Error.internalBinaryRead(reader, reader.uint32(), options, (message.resp as any).error)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: AbiResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.abi.v1.RespResult res = 1; */
        if (message.resp.oneofKind === "res")
            RespResult.internalBinaryWrite(message.resp.res, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.abi.v1.Error error = 2; */
        if (message.resp.oneofKind === "error")
            Error.internalBinaryWrite(message.resp.error, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class NativeAmountToStringRequest$Type extends MessageType<NativeAmountToStringRequest> {
    ...
    create(value?: PartialMessage<NativeAmountToStringRequest>): NativeAmountToStringRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: NativeAmountToStringRequest): NativeAmountToStringRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount to_convert */ 1:
                    message.toConvert = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.toConvert);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: NativeAmountToStringRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount to_convert = 1; */
        if (message.toConvert)
            NativeAmount.internalBinaryWrite(message.toConvert, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const NativeAmountToStringRequest = new NativeAmountToStringRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class NativeAmountToStringResult$Type extends MessageType<NativeAmountToStringResult> {
    ...
    create(value?: PartialMessage<NativeAmountToStringResult>): NativeAmountToStringResult {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: NativeAmountToStringResult): NativeAmountToStringResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: NativeAmountToStringResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class NativeAmountFromStringRequest$Type extends MessageType<NativeAmountFromStringRequest> {
    ...
    create(value?: PartialMessage<NativeAmountFromStringRequest>): NativeAmountFromStringRequest {
        const message = { toConvert: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<NativeAmountFromStringRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: NativeAmountFromStringRequest): NativeAmountFromStringRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: NativeAmountFromStringRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string to_convert = 1; */
        if (message.toConvert !== "")
 ...
 */
export const NativeAmountFromStringRequest = new NativeAmountFromStringRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class NativeAmountFromStringResult$Type extends MessageType<NativeAmountFromStringResult> {
    constructor() {
        super("massa.abi.v1.NativeAmountFromStringResult", [
            { no: 1, name: "converted_amount", kind: "message", T: () => NativeAmount }
        ]);
    }
    create(value?: PartialMessage<NativeAmountFromStringResult>): NativeAmountFromStringResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<NativeAmountFromStringResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: NativeAmountFromStringResult): NativeAmountFromStringResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount converted_amount */ 1:
                    message.convertedAmount = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.convertedAmount);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: NativeAmountFromStringResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount converted_amount = 1; */
        if (message.convertedAmount)
            NativeAmount.internalBinaryWrite(message.convertedAmount, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const NativeAmountFromStringResult = new NativeAmountFromStringResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CheckAddressRequest$Type extends MessageType<CheckAddressRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckAddressRequest): CheckAddressRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckAddressRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string to_check = 1; */
        if (message.toCheck !== "")
...
class CheckAddressResult$Type extends MessageType<CheckAddressResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckAddressResult): CheckAddressResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckAddressResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_valid = 1; */
...
class CheckPubKeyRequest$Type extends MessageType<CheckPubKeyRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckPubKeyRequest): CheckPubKeyRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckPubKeyRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string to_check = 1; */
        if (message.toCheck !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.toCheck);
        let u = options.writeUnknownFields;
...
class CheckPubKeyResult$Type extends MessageType<CheckPubKeyResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckPubKeyResult): CheckPubKeyResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckPubKeyResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_valid = 1; */
        if (message.isValid !== false)
            writer.tag(1, WireType.Varint).bool(message.isValid);
        let u = options.writeUnknownFields;
...
class CheckSigRequest$Type extends MessageType<CheckSigRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckSigRequest): CheckSigRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckSigRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string to_check = 1; */
        if (message.toCheck !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.toCheck);
        let u = options.writeUnknownFields;
...
class CheckSigResult$Type extends MessageType<CheckSigResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckSigResult): CheckSigResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckSigResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_valid = 1; */
        if (message.isValid !== false)
            writer.tag(1, WireType.Varint).bool(message.isValid);
        let u = options.writeUnknownFields;
...
class CheckNativeAmountRequest$Type extends MessageType<CheckNativeAmountRequest> {
    ...
    create(value?: PartialMessage<CheckNativeAmountRequest>): CheckNativeAmountRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckNativeAmountRequest): CheckNativeAmountRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount to_check */ 1:
                    message.toCheck = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.toCheck);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CheckNativeAmountRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount to_check = 1; */
        if (message.toCheck)
            NativeAmount.internalBinaryWrite(message.toCheck, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CheckNativeAmountResult$Type extends MessageType<CheckNativeAmountResult> {
    ...
    create(value?: PartialMessage<CheckNativeAmountResult>): CheckNativeAmountResult {
        const message = { isValid: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckNativeAmountResult): CheckNativeAmountResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckNativeAmountResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_valid = 1; */
        if (message.isValid !== false)
            writer.tag(1, WireType.Varint).bool(message.isValid);
        let u = options.writeUnknownFields;
...
class AddNativeAmountRequest$Type extends MessageType<AddNativeAmountRequest> {
    ...
    create(value?: PartialMessage<AddNativeAmountRequest>): AddNativeAmountRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AddNativeAmountRequest): AddNativeAmountRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount amount1 */ 1:
                    message.amount1 = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.amount1);
                    break;
                case /* massa.model.v1.NativeAmount amount2 */ 2:
                    message.amount2 = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.amount2);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: AddNativeAmountRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount amount1 = 1; */
        if (message.amount1)
            NativeAmount.internalBinaryWrite(message.amount1, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeAmount amount2 = 2; */
        if (message.amount2)
            NativeAmount.internalBinaryWrite(message.amount2, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class AddNativeAmountResult$Type extends MessageType<AddNativeAmountResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AddNativeAmountResult): AddNativeAmountResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount sum */ 1:
                    message.sum = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.sum);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: AddNativeAmountResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount sum = 1; */
        if (message.sum)
            NativeAmount.internalBinaryWrite(message.sum, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SubNativeAmountRequest$Type extends MessageType<SubNativeAmountRequest> {
    ...
    create(value?: PartialMessage<SubNativeAmountRequest>): SubNativeAmountRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SubNativeAmountRequest): SubNativeAmountRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount left */ 1:
                    message.left = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.left);
                    break;
                case /* massa.model.v1.NativeAmount right */ 2:
                    message.right = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.right);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SubNativeAmountRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount left = 1; */
        if (message.left)
            NativeAmount.internalBinaryWrite(message.left, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeAmount right = 2; */
        if (message.right)
            NativeAmount.internalBinaryWrite(message.right, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SubNativeAmountResult$Type extends MessageType<SubNativeAmountResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SubNativeAmountResult): SubNativeAmountResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount difference */ 1:
                    message.difference = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.difference);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SubNativeAmountResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount difference = 1; */
        if (message.difference)
            NativeAmount.internalBinaryWrite(message.difference, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ScalarMulNativeAmountRequest$Type extends MessageType<ScalarMulNativeAmountRequest> {
    ...
    create(value?: PartialMessage<ScalarMulNativeAmountRequest>): ScalarMulNativeAmountRequest {
        const message = { coefficient: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ScalarMulNativeAmountRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ScalarMulNativeAmountRequest): ScalarMulNativeAmountRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ScalarMulNativeAmountRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount amount = 1; */
        if (message.amount)
            NativeAmount.internalBinaryWrite(message.amount, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
 ...
 */
export const ScalarMulNativeAmountRequest = new ScalarMulNativeAmountRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ScalarMulNativeAmountResult$Type extends MessageType<ScalarMulNativeAmountResult> {
    ...
    create(value?: PartialMessage<ScalarMulNativeAmountResult>): ScalarMulNativeAmountResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ScalarMulNativeAmountResult): ScalarMulNativeAmountResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount product */ 1:
                    message.product = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.product);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ScalarMulNativeAmountResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount product = 1; */
        if (message.product)
            NativeAmount.internalBinaryWrite(message.product, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const ScalarMulNativeAmountResult = new ScalarMulNativeAmountResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ScalarDivRemNativeAmountRequest$Type extends MessageType<ScalarDivRemNativeAmountRequest> {
    ...
    create(value?: PartialMessage<ScalarDivRemNativeAmountRequest>): ScalarDivRemNativeAmountRequest {
        const message = { divisor: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ScalarDivRemNativeAmountRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ScalarDivRemNativeAmountRequest): ScalarDivRemNativeAmountRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount dividend */ 1:
                    message.dividend = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.dividend);
                    break;
    ...
    internalBinaryWrite(message: ScalarDivRemNativeAmountRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount dividend = 1; */
        if (message.dividend)
            NativeAmount.internalBinaryWrite(message.dividend, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* uint64 divisor = 2; */
 ...
 */
export const ScalarDivRemNativeAmountRequest = new ScalarDivRemNativeAmountRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ScalarDivRemNativeAmountResult$Type extends MessageType<ScalarDivRemNativeAmountResult> {
    ...
    create(value?: PartialMessage<ScalarDivRemNativeAmountResult>): ScalarDivRemNativeAmountResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ScalarDivRemNativeAmountResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ScalarDivRemNativeAmountResult): ScalarDivRemNativeAmountResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeAmount quotient */ 1:
                    message.quotient = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.quotient);
                    break;
                case /* massa.model.v1.NativeAmount remainder */ 2:
                    message.remainder = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.remainder);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ScalarDivRemNativeAmountResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount quotient = 1; */
        if (message.quotient)
            NativeAmount.internalBinaryWrite(message.quotient, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeAmount remainder = 2; */
        if (message.remainder)
            NativeAmount.internalBinaryWrite(message.remainder, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const ScalarDivRemNativeAmountResult = new ScalarDivRemNativeAmountResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DivRemNativeAmountRequest$Type extends MessageType<DivRemNativeAmountRequest> {
    ...
    create(value?: PartialMessage<DivRemNativeAmountRequest>): DivRemNativeAmountRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DivRemNativeAmountRequest): DivRemNativeAmountRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* massa.model.v1.NativeAmount divisor */ 2:
                    message.divisor = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.divisor);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: DivRemNativeAmountRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount dividend = 1; */
        if (message.dividend)
            NativeAmount.internalBinaryWrite(message.dividend, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeAmount divisor = 2; */
        if (message.divisor)
            NativeAmount.internalBinaryWrite(message.divisor, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class DivRemNativeAmountResult$Type extends MessageType<DivRemNativeAmountResult> {
    ...
    create(value?: PartialMessage<DivRemNativeAmountResult>): DivRemNativeAmountResult {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DivRemNativeAmountResult): DivRemNativeAmountResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DivRemNativeAmountResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint64 quotient = 1; */
...
class CheckedAddNativeTimeRequest$Type extends MessageType<CheckedAddNativeTimeRequest> {
    ...
    create(value?: PartialMessage<CheckedAddNativeTimeRequest>): CheckedAddNativeTimeRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedAddNativeTimeRequest): CheckedAddNativeTimeRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeTime left */ 1:
                    message.left = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.left);
                    break;
                case /* massa.model.v1.NativeTime right */ 2:
                    message.right = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.right);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CheckedAddNativeTimeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime left = 1; */
        if (message.left)
            NativeTime.internalBinaryWrite(message.left, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeTime right = 2; */
        if (message.right)
            NativeTime.internalBinaryWrite(message.right, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const CheckedAddNativeTimeRequest = new CheckedAddNativeTimeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CheckedAddNativeTimeResult$Type extends MessageType<CheckedAddNativeTimeResult> {
    ...
    create(value?: PartialMessage<CheckedAddNativeTimeResult>): CheckedAddNativeTimeResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedAddNativeTimeResult): CheckedAddNativeTimeResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeTime sum */ 1:
                    message.sum = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.sum);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CheckedAddNativeTimeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime sum = 1; */
        if (message.sum)
            NativeTime.internalBinaryWrite(message.sum, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CheckedSubNativeTimeRequest$Type extends MessageType<CheckedSubNativeTimeRequest> {
    ...
    create(value?: PartialMessage<CheckedSubNativeTimeRequest>): CheckedSubNativeTimeRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedSubNativeTimeRequest): CheckedSubNativeTimeRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckedSubNativeTimeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime left = 1; */
        if (message.left)
            NativeTime.internalBinaryWrite(message.left, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeTime right = 2; */
 ...
 */
export const CheckedSubNativeTimeRequest = new CheckedSubNativeTimeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CheckedSubNativeTimeResult$Type extends MessageType<CheckedSubNativeTimeResult> {
    ...
    create(value?: PartialMessage<CheckedSubNativeTimeResult>): CheckedSubNativeTimeResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedSubNativeTimeResult): CheckedSubNativeTimeResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeTime difference */ 1:
                    message.difference = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.difference);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CheckedSubNativeTimeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime difference = 1; */
        if (message.difference)
            NativeTime.internalBinaryWrite(message.difference, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CheckedScalarMulNativeTimeRequest$Type extends MessageType<CheckedScalarMulNativeTimeRequest> {
    ...
    create(value?: PartialMessage<CheckedScalarMulNativeTimeRequest>): CheckedScalarMulNativeTimeRequest {
        const message = { coefficient: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CheckedScalarMulNativeTimeRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedScalarMulNativeTimeRequest): CheckedScalarMulNativeTimeRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeTime time */ 1:
                    message.time = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.time);
                    break;
                case /* uint64 coefficient */ 2:
                    message.coefficient = reader.uint64().toBigInt();
                    break;
    ...
    internalBinaryWrite(message: CheckedScalarMulNativeTimeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime time = 1; */
        if (message.time)
            NativeTime.internalBinaryWrite(message.time, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* uint64 coefficient = 2; */
        if (message.coefficient !== 0n)
            writer.tag(2, WireType.Varint).uint64(message.coefficient);
        let u = options.writeUnknownFields;
 ...
 */
export const CheckedScalarMulNativeTimeRequest = new CheckedScalarMulNativeTimeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CheckedScalarMulNativeTimeResult$Type extends MessageType<CheckedScalarMulNativeTimeResult> {
    ...
    create(value?: PartialMessage<CheckedScalarMulNativeTimeResult>): CheckedScalarMulNativeTimeResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CheckedScalarMulNativeTimeResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedScalarMulNativeTimeResult): CheckedScalarMulNativeTimeResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeTime product */ 1:
                    message.product = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.product);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CheckedScalarMulNativeTimeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime product = 1; */
        if (message.product)
            NativeTime.internalBinaryWrite(message.product, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const CheckedScalarMulNativeTimeResult = new CheckedScalarMulNativeTimeResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CheckedScalarDivRemNativeTimeRequest$Type extends MessageType<CheckedScalarDivRemNativeTimeRequest> {
    ...
    create(value?: PartialMessage<CheckedScalarDivRemNativeTimeRequest>): CheckedScalarDivRemNativeTimeRequest {
        const message = { divisor: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CheckedScalarDivRemNativeTimeRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedScalarDivRemNativeTimeRequest): CheckedScalarDivRemNativeTimeRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeTime dividend */ 1:
                    message.dividend = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.dividend);
                    break;
                case /* uint64 divisor */ 2:
                    message.divisor = reader.uint64().toBigInt();
                    break;
    ...
    internalBinaryWrite(message: CheckedScalarDivRemNativeTimeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime dividend = 1; */
        if (message.dividend)
            NativeTime.internalBinaryWrite(message.dividend, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* uint64 divisor = 2; */
        if (message.divisor !== 0n)
            writer.tag(2, WireType.Varint).uint64(message.divisor);
        let u = options.writeUnknownFields;
 ...
 */
export const CheckedScalarDivRemNativeTimeRequest = new CheckedScalarDivRemNativeTimeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CheckedScalarDivRemNativeTimeResult$Type extends MessageType<CheckedScalarDivRemNativeTimeResult> {
    ...
    create(value?: PartialMessage<CheckedScalarDivRemNativeTimeResult>): CheckedScalarDivRemNativeTimeResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CheckedScalarDivRemNativeTimeResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedScalarDivRemNativeTimeResult): CheckedScalarDivRemNativeTimeResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* massa.model.v1.NativeTime quotient */ 1:
                    message.quotient = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.quotient);
                    break;
                case /* massa.model.v1.NativeTime remainder */ 2:
                    message.remainder = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.remainder);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CheckedScalarDivRemNativeTimeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime quotient = 1; */
        if (message.quotient)
            NativeTime.internalBinaryWrite(message.quotient, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeTime remainder = 2; */
        if (message.remainder)
            NativeTime.internalBinaryWrite(message.remainder, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const CheckedScalarDivRemNativeTimeResult = new CheckedScalarDivRemNativeTimeResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CheckedDivRemNativeTimeRequest$Type extends MessageType<CheckedDivRemNativeTimeRequest> {
    ...
    create(value?: PartialMessage<CheckedDivRemNativeTimeRequest>): CheckedDivRemNativeTimeRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CheckedDivRemNativeTimeRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedDivRemNativeTimeRequest): CheckedDivRemNativeTimeRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* massa.model.v1.NativeTime divisor */ 2:
                    message.divisor = NativeTime.internalBinaryRead(reader, reader.uint32(), options, message.divisor);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CheckedDivRemNativeTimeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime dividend = 1; */
        if (message.dividend)
            NativeTime.internalBinaryWrite(message.dividend, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeTime divisor = 2; */
        if (message.divisor)
            NativeTime.internalBinaryWrite(message.divisor, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const CheckedDivRemNativeTimeRequest = new CheckedDivRemNativeTimeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CheckedDivRemNativeTimeResult$Type extends MessageType<CheckedDivRemNativeTimeResult> {
    ...
    create(value?: PartialMessage<CheckedDivRemNativeTimeResult>): CheckedDivRemNativeTimeResult {
        const message = { quotient: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CheckedDivRemNativeTimeResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckedDivRemNativeTimeResult): CheckedDivRemNativeTimeResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckedDivRemNativeTimeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint64 quotient = 1; */
        if (message.quotient !== 0n)
            writer.tag(1, WireType.Varint).uint64(message.quotient);
        /* massa.model.v1.NativeTime remainder = 2; */
 ...
 */
export const CheckedDivRemNativeTimeResult = new CheckedDivRemNativeTimeResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CompareNativeTimeRequest$Type extends MessageType<CompareNativeTimeRequest> {
    ...
    create(value?: PartialMessage<CompareNativeTimeRequest>): CompareNativeTimeRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CompareNativeTimeRequest): CompareNativeTimeRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CompareNativeTimeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime left = 1; */
        if (message.left)
            NativeTime.internalBinaryWrite(message.left, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeTime right = 2; */
...
class CompareNativeTimeResult$Type extends MessageType<CompareNativeTimeResult> {
    constructor() {
        super("massa.abi.v1.CompareNativeTimeResult", [
            { no: 1, name: "result", kind: "enum", T: () => ["massa.model.v1.ComparisonResult", ComparisonResult, "COMPARISON_RESULT_"] }
        ]);
    }
    create(value?: PartialMessage<CompareNativeTimeResult>): CompareNativeTimeResult {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CompareNativeTimeResult): CompareNativeTimeResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CompareNativeTimeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class CompareAddressRequest$Type extends MessageType<CompareAddressRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CompareAddressRequest): CompareAddressRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CompareAddressRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string left = 1; */
        if (message.left !== "")
...
class CompareAddressResult$Type extends MessageType<CompareAddressResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CompareAddressResult): CompareAddressResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CompareAddressResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.ComparisonResult result = 1; */
        if (message.result !== 0)
            writer.tag(1, WireType.Varint).int32(message.result);
        let u = options.writeUnknownFields;
...
class ComparePubKeyRequest$Type extends MessageType<ComparePubKeyRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ComparePubKeyRequest): ComparePubKeyRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ComparePubKeyRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string left = 1; */
        if (message.left !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.left);
        /* string right = 2; */
...
class ComparePubKeyResult$Type extends MessageType<ComparePubKeyResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ComparePubKeyResult): ComparePubKeyResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ComparePubKeyResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.ComparisonResult result = 1; */
        if (message.result !== 0)
            writer.tag(1, WireType.Varint).int32(message.result);
        let u = options.writeUnknownFields;
...
class VerifySigRequest$Type extends MessageType<VerifySigRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: VerifySigRequest): VerifySigRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: VerifySigRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string sig = 1; */
        if (message.sig !== "")
...
class VerifySigResult$Type extends MessageType<VerifySigResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: VerifySigResult): VerifySigResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: VerifySigResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_verified = 1; */
...
class CompareNativeAmountRequest$Type extends MessageType<CompareNativeAmountRequest> {
    ...
    create(value?: PartialMessage<CompareNativeAmountRequest>): CompareNativeAmountRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CompareNativeAmountRequest): CompareNativeAmountRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CompareNativeAmountRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount left = 1; */
        if (message.left)
            NativeAmount.internalBinaryWrite(message.left, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.NativeAmount right = 2; */
...
class CompareNativeAmountResult$Type extends MessageType<CompareNativeAmountResult> {
    ...
    create(value?: PartialMessage<CompareNativeAmountResult>): CompareNativeAmountResult {
        const message = { result: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CompareNativeAmountResult): CompareNativeAmountResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CompareNativeAmountResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.ComparisonResult result = 1; */
        if (message.result !== 0)
            writer.tag(1, WireType.Varint).int32(message.result);
        let u = options.writeUnknownFields;
...
class Keccak256Request$Type extends MessageType<Keccak256Request> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Keccak256Request): Keccak256Request {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Keccak256Request, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes data = 1; */
        if (message.data.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.data);
        let u = options.writeUnknownFields;
...
class Keccak256Result$Type extends MessageType<Keccak256Result> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Keccak256Result): Keccak256Result {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Keccak256Result, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes hash = 1; */
...
class EvmVerifySigRequest$Type extends MessageType<EvmVerifySigRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EvmVerifySigRequest): EvmVerifySigRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: EvmVerifySigRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes sig = 1; */
...
class EvmVerifySigResult$Type extends MessageType<EvmVerifySigResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EvmVerifySigResult): EvmVerifySigResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: EvmVerifySigResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_verified = 1; */
        if (message.isVerified !== false)
            writer.tag(1, WireType.Varint).bool(message.isVerified);
        let u = options.writeUnknownFields;
...
class EvmGetAddressFromPubkeyRequest$Type extends MessageType<EvmGetAddressFromPubkeyRequest> {
    ...
    create(value?: PartialMessage<EvmGetAddressFromPubkeyRequest>): EvmGetAddressFromPubkeyRequest {
        const message = { pubKey: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<EvmGetAddressFromPubkeyRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EvmGetAddressFromPubkeyRequest): EvmGetAddressFromPubkeyRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: EvmGetAddressFromPubkeyRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes pub_key = 1; */
        if (message.pubKey.length)
 ...
 */
export const EvmGetAddressFromPubkeyRequest = new EvmGetAddressFromPubkeyRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EvmGetAddressFromPubkeyResult$Type extends MessageType<EvmGetAddressFromPubkeyResult> {
    ...
    create(value?: PartialMessage<EvmGetAddressFromPubkeyResult>): EvmGetAddressFromPubkeyResult {
        const message = { address: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<EvmGetAddressFromPubkeyResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EvmGetAddressFromPubkeyResult): EvmGetAddressFromPubkeyResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: EvmGetAddressFromPubkeyResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes address = 1; */
 ...
 */
export const EvmGetAddressFromPubkeyResult = new EvmGetAddressFromPubkeyResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EvmGetPubkeyFromSignatureRequest$Type extends MessageType<EvmGetPubkeyFromSignatureRequest> {
    ...
    create(value?: PartialMessage<EvmGetPubkeyFromSignatureRequest>): EvmGetPubkeyFromSignatureRequest {
        const message = { hash: new Uint8Array(0), sig: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<EvmGetPubkeyFromSignatureRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EvmGetPubkeyFromSignatureRequest): EvmGetPubkeyFromSignatureRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: EvmGetPubkeyFromSignatureRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes hash = 1; */
        if (message.hash.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.hash);
        /* bytes sig = 2; */
 ...
 */
export const EvmGetPubkeyFromSignatureRequest = new EvmGetPubkeyFromSignatureRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EvmGetPubkeyFromSignatureResult$Type extends MessageType<EvmGetPubkeyFromSignatureResult> {
    ...
    create(value?: PartialMessage<EvmGetPubkeyFromSignatureResult>): EvmGetPubkeyFromSignatureResult {
        const message = { pubKey: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<EvmGetPubkeyFromSignatureResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EvmGetPubkeyFromSignatureResult): EvmGetPubkeyFromSignatureResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: EvmGetPubkeyFromSignatureResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes pub_key = 1; */
        if (message.pubKey.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.pubKey);
        let u = options.writeUnknownFields;
 ...
 */
export const EvmGetPubkeyFromSignatureResult = new EvmGetPubkeyFromSignatureResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class IsAddressEoaRequest$Type extends MessageType<IsAddressEoaRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IsAddressEoaRequest): IsAddressEoaRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: IsAddressEoaRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string address = 1; */
        if (message.address !== "")
...
class IsAddressEoaResult$Type extends MessageType<IsAddressEoaResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IsAddressEoaResult): IsAddressEoaResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: IsAddressEoaResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_eoa = 1; */
...
class HashBlake3Request$Type extends MessageType<HashBlake3Request> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HashBlake3Request): HashBlake3Request {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: HashBlake3Request, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes data = 1; */
        if (message.data.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.data);
        let u = options.writeUnknownFields;
...
class HashBlake3Result$Type extends MessageType<HashBlake3Result> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HashBlake3Result): HashBlake3Result {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: HashBlake3Result, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes hash = 1; */
        if (message.hash.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.hash);
        let u = options.writeUnknownFields;
...
class GetDsKeysRequest$Type extends MessageType<GetDsKeysRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetDsKeysRequest): GetDsKeysRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetDsKeysRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes prefix = 1; */
...
class GetDsKeysResult$Type extends MessageType<GetDsKeysResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetDsKeysResult): GetDsKeysResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetDsKeysResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SetDsValueRequest$Type extends MessageType<SetDsValueRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SetDsValueRequest): SetDsValueRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SetDsValueRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes key = 1; */
...
class SetDsValueResult$Type extends MessageType<SetDsValueResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SetDsValueResult): SetDsValueResult {
        return target ?? this.create();
    }
    internalBinaryWrite(message: SetDsValueResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class AppendDsValueRequest$Type extends MessageType<AppendDsValueRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AppendDsValueRequest): AppendDsValueRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: AppendDsValueRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes key = 1; */
        if (message.key.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.key);
        /* bytes value = 2; */
...
class AppendDsValueResult$Type extends MessageType<AppendDsValueResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AppendDsValueResult): AppendDsValueResult {
        return target ?? this.create();
    }
    internalBinaryWrite(message: AppendDsValueResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetDsValueRequest$Type extends MessageType<GetDsValueRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetDsValueRequest): GetDsValueRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetDsValueRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes key = 1; */
        if (message.key.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.key);
        /* optional google.protobuf.StringValue address = 2; */
...
class GetDsValueResult$Type extends MessageType<GetDsValueResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetDsValueResult): GetDsValueResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetDsValueResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes value = 1; */
        if (message.value.length)
...
class DeleteDsEntryRequest$Type extends MessageType<DeleteDsEntryRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeleteDsEntryRequest): DeleteDsEntryRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DeleteDsEntryRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes key = 1; */
        if (message.key.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.key);
        /* optional google.protobuf.StringValue address = 2; */
...
class DeleteDsEntryResult$Type extends MessageType<DeleteDsEntryResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeleteDsEntryResult): DeleteDsEntryResult {
        return target ?? this.create();
    }
    internalBinaryWrite(message: DeleteDsEntryResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class DsEntryExistsRequest$Type extends MessageType<DsEntryExistsRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DsEntryExistsRequest): DsEntryExistsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DsEntryExistsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes key = 1; */
        if (message.key.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.key);
        /* optional google.protobuf.StringValue address = 2; */
...
class DsEntryExistsResult$Type extends MessageType<DsEntryExistsResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DsEntryExistsResult): DsEntryExistsResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DsEntryExistsResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool has_data = 1; */
...
class GetOwnedAddressesRequest$Type extends MessageType<GetOwnedAddressesRequest> {
    ...
    create(value?: PartialMessage<GetOwnedAddressesRequest>): GetOwnedAddressesRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOwnedAddressesRequest): GetOwnedAddressesRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: GetOwnedAddressesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetOwnedAddressesResult$Type extends MessageType<GetOwnedAddressesResult> {
    ...
    create(value?: PartialMessage<GetOwnedAddressesResult>): GetOwnedAddressesResult {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOwnedAddressesResult): GetOwnedAddressesResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetOwnedAddressesResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class GetCallStackRequest$Type extends MessageType<GetCallStackRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetCallStackRequest): GetCallStackRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: GetCallStackRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetCallStackResult$Type extends MessageType<GetCallStackResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetCallStackResult): GetCallStackResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetCallStackResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class AddressFromPubKeyRequest$Type extends MessageType<AddressFromPubKeyRequest> {
    ...
    create(value?: PartialMessage<AddressFromPubKeyRequest>): AddressFromPubKeyRequest {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AddressFromPubKeyRequest): AddressFromPubKeyRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: AddressFromPubKeyRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string pub_key = 1; */
        if (message.pubKey !== "")
...
class AddressFromPubKeyResult$Type extends MessageType<AddressFromPubKeyResult> {
    ...
    create(value?: PartialMessage<AddressFromPubKeyResult>): AddressFromPubKeyResult {
        const message = { address: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AddressFromPubKeyResult): AddressFromPubKeyResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: AddressFromPubKeyResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string address = 1; */
        if (message.address !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.address);
        let u = options.writeUnknownFields;
...
class UnsafeRandomRequest$Type extends MessageType<UnsafeRandomRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UnsafeRandomRequest): UnsafeRandomRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UnsafeRandomRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 num_bytes = 2; */
...
class UnsafeRandomResult$Type extends MessageType<UnsafeRandomResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UnsafeRandomResult): UnsafeRandomResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UnsafeRandomResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SendAsyncMessageFilter$Type extends MessageType<SendAsyncMessageFilter> {
    ...
    create(value?: PartialMessage<SendAsyncMessageFilter>): SendAsyncMessageFilter {
        const message = { targetAddress: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SendAsyncMessageFilter): SendAsyncMessageFilter {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* google.protobuf.BytesValue target_key */ 2:
                    message.targetKey = BytesValue.internalBinaryRead(reader, reader.uint32(), options, message.targetKey);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SendAsyncMessageFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string target_address = 1; */
        if (message.targetAddress !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.targetAddress);
        /* google.protobuf.BytesValue target_key = 2; */
        if (message.targetKey)
            BytesValue.internalBinaryWrite(message.targetKey, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SendAsyncMessageRequest$Type extends MessageType<SendAsyncMessageRequest> {
    constructor() {
        super("massa.abi.v1.SendAsyncMessageRequest", [
            ...
            { no: 9, name: "filter", kind: "message", T: () => SendAsyncMessageFilter }
        ]);
    }
    create(value?: PartialMessage<SendAsyncMessageRequest>): SendAsyncMessageRequest {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SendAsyncMessageRequest): SendAsyncMessageRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* massa.abi.v1.SendAsyncMessageFilter filter */ 9:
                    message.filter = SendAsyncMessageFilter.internalBinaryRead(reader, reader.uint32(), options, message.filter);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SendAsyncMessageRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string target_address = 1; */
        if (message.targetAddress !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.targetAddress);
        ...
        if (message.validityStart)
            Slot.internalBinaryWrite(message.validityStart, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* massa.model.v1.Slot validity_end = 4; */
        if (message.validityEnd)
            Slot.internalBinaryWrite(message.validityEnd, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.filter)
            SendAsyncMessageFilter.internalBinaryWrite(message.filter, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SendAsyncMessageResult$Type extends MessageType<SendAsyncMessageResult> {
    ...
    create(value?: PartialMessage<SendAsyncMessageResult>): SendAsyncMessageResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SendAsyncMessageResult): SendAsyncMessageResult {
        return target ?? this.create();
    }
    internalBinaryWrite(message: SendAsyncMessageResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetOriginOperationIdRequest$Type extends MessageType<GetOriginOperationIdRequest> {
    ...
    create(value?: PartialMessage<GetOriginOperationIdRequest>): GetOriginOperationIdRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOriginOperationIdRequest): GetOriginOperationIdRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: GetOriginOperationIdRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const GetOriginOperationIdRequest = new GetOriginOperationIdRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetOriginOperationIdResult$Type extends MessageType<GetOriginOperationIdResult> {
    ...
    create(value?: PartialMessage<GetOriginOperationIdResult>): GetOriginOperationIdResult {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOriginOperationIdResult): GetOriginOperationIdResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* optional google.protobuf.StringValue operation_id */ 1:
                    message.operationId = StringValue.internalBinaryRead(reader, reader.uint32(), options, message.operationId);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetOriginOperationIdResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional google.protobuf.StringValue operation_id = 1; */
        if (message.operationId)
            StringValue.internalBinaryWrite(message.operationId, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetNativeTimeRequest$Type extends MessageType<GetNativeTimeRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetNativeTimeRequest): GetNativeTimeRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: GetNativeTimeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetNativeTimeResult$Type extends MessageType<GetNativeTimeResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetNativeTimeResult): GetNativeTimeResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetNativeTimeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeTime time = 1; */
        if (message.time)
            NativeTime.internalBinaryWrite(message.time, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
class GetCurrentSlotRequest$Type extends MessageType<GetCurrentSlotRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetCurrentSlotRequest): GetCurrentSlotRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: GetCurrentSlotRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetCurrentSlotResult$Type extends MessageType<GetCurrentSlotResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetCurrentSlotResult): GetCurrentSlotResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetCurrentSlotResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SetBytecodeRequest$Type extends MessageType<SetBytecodeRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SetBytecodeRequest): SetBytecodeRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SetBytecodeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes bytecode = 1; */
        if (message.bytecode.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.bytecode);
        /* optional google.protobuf.StringValue address = 2; */
...
class SetBytecodeResult$Type extends MessageType<SetBytecodeResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SetBytecodeResult): SetBytecodeResult {
        return target ?? this.create();
    }
    internalBinaryWrite(message: SetBytecodeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetBytecodeRequest$Type extends MessageType<GetBytecodeRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBytecodeRequest): GetBytecodeRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBytecodeRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional google.protobuf.StringValue address = 1; */
        if (message.address)
            StringValue.internalBinaryWrite(message.address, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetBytecodeResult$Type extends MessageType<GetBytecodeResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBytecodeResult): GetBytecodeResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBytecodeResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes bytecode = 1; */
        if (message.bytecode.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.bytecode);
        let u = options.writeUnknownFields;
...
class CallerHasWriteAccessRequest$Type extends MessageType<CallerHasWriteAccessRequest> {
    ...
    create(value?: PartialMessage<CallerHasWriteAccessRequest>): CallerHasWriteAccessRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CallerHasWriteAccessRequest): CallerHasWriteAccessRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: CallerHasWriteAccessRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CallerHasWriteAccessResult$Type extends MessageType<CallerHasWriteAccessResult> {
    ...
    create(value?: PartialMessage<CallerHasWriteAccessResult>): CallerHasWriteAccessResult {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CallerHasWriteAccessResult): CallerHasWriteAccessResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CallerHasWriteAccessResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class HashSha256Request$Type extends MessageType<HashSha256Request> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HashSha256Request): HashSha256Request {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: HashSha256Request, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes data = 1; */
        if (message.data.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.data);
        let u = options.writeUnknownFields;
...
class HashSha256Result$Type extends MessageType<HashSha256Result> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HashSha256Result): HashSha256Result {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: HashSha256Result, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes hash = 1; */
        if (message.hash.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.hash);
        let u = options.writeUnknownFields;
...
class GetOpDataRequest$Type extends MessageType<GetOpDataRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOpDataRequest): GetOpDataRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetOpDataRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes key = 1; */
        if (message.key.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.key);
        let u = options.writeUnknownFields;
...
class GetOpDataResult$Type extends MessageType<GetOpDataResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOpDataResult): GetOpDataResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetOpDataResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes value = 1; */
        if (message.value.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.value);
        let u = options.writeUnknownFields;
...
class OpEntryExistsRequest$Type extends MessageType<OpEntryExistsRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: OpEntryExistsRequest): OpEntryExistsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: OpEntryExistsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes key = 1; */
        if (message.key.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.key);
        let u = options.writeUnknownFields;
...
class OpEntryExistsResult$Type extends MessageType<OpEntryExistsResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: OpEntryExistsResult): OpEntryExistsResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: OpEntryExistsResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool has_key = 1; */
...
class GetOpKeysRequest$Type extends MessageType<GetOpKeysRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOpKeysRequest): GetOpKeysRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetOpKeysRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes prefix = 1; */
        if (message.prefix.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.prefix);
        let u = options.writeUnknownFields;
...
class GetOpKeysResult$Type extends MessageType<GetOpKeysResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOpKeysResult): GetOpKeysResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetOpKeysResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated bytes keys = 1; */
        for (let i = 0; i < message.keys.length; i++)
            writer.tag(1, WireType.LengthDelimited).bytes(message.keys[i]);
        let u = options.writeUnknownFields;
...
class GetRemainingGasRequest$Type extends MessageType<GetRemainingGasRequest> {
    ...
    create(value?: PartialMessage<GetRemainingGasRequest>): GetRemainingGasRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetRemainingGasRequest): GetRemainingGasRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: GetRemainingGasRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetRemainingGasResult$Type extends MessageType<GetRemainingGasResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetRemainingGasResult): GetRemainingGasResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetRemainingGasResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class GetBalanceResult$Type extends MessageType<GetBalanceResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBalanceResult): GetBalanceResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBalanceResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class GetCallCoinsRequest$Type extends MessageType<GetCallCoinsRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetCallCoinsRequest): GetCallCoinsRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: GetCallCoinsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetCallCoinsResult$Type extends MessageType<GetCallCoinsResult> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetCallCoinsResult): GetCallCoinsResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetCallCoinsResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* massa.model.v1.NativeAmount coins = 1; */
        if (message.coins)
            NativeAmount.internalBinaryWrite(message.coins, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetAddressVersionRequest$Type extends MessageType<GetAddressVersionRequest> {
    ...
    create(value?: PartialMessage<GetAddressVersionRequest>): GetAddressVersionRequest {
        const message = { address: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetAddressVersionRequest): GetAddressVersionRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetAddressVersionRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string address = 1; */
        if (message.address !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.address);
        let u = options.writeUnknownFields;
...
class GetAddressVersionResult$Type extends MessageType<GetAddressVersionResult> {
    ...
    create(value?: PartialMessage<GetAddressVersionResult>): GetAddressVersionResult {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetAddressVersionResult): GetAddressVersionResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetAddressVersionResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint64 version = 1; */
...
class GetAddressCategoryRequest$Type extends MessageType<GetAddressCategoryRequest> {
    ...
    create(value?: PartialMessage<GetAddressCategoryRequest>): GetAddressCategoryRequest {
        const message = { address: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetAddressCategoryRequest): GetAddressCategoryRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetAddressCategoryRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string address = 1; */
        if (message.address !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.address);
        let u = options.writeUnknownFields;
...
class GetAddressCategoryResult$Type extends MessageType<GetAddressCategoryResult> {
    ...
    create(value?: PartialMessage<GetAddressCategoryResult>): GetAddressCategoryResult {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetAddressCategoryResult): GetAddressCategoryResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetAddressCategoryResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class GetPubKeyVersionRequest$Type extends MessageType<GetPubKeyVersionRequest> {
    ...
    create(value?: PartialMessage<GetPubKeyVersionRequest>): GetPubKeyVersionRequest {
        const message = { pubKey: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetPubKeyVersionRequest): GetPubKeyVersionRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetPubKeyVersionRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string pub_key = 1; */
        if (message.pubKey !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.pubKey);
        let u = options.writeUnknownFields;
...
class GetPubKeyVersionResult$Type extends MessageType<GetPubKeyVersionResult> {
    ...
    create(value?: PartialMessage<GetPubKeyVersionResult>): GetPubKeyVersionResult {
        const message = { version: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetPubKeyVersionResult): GetPubKeyVersionResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetPubKeyVersionResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint64 version = 1; */
        if (message.version !== 0n)
            writer.tag(1, WireType.Varint).uint64(message.version);
        let u = options.writeUnknownFields;
...
class GetSignatureVersionRequest$Type extends MessageType<GetSignatureVersionRequest> {
    ...
    create(value?: PartialMessage<GetSignatureVersionRequest>): GetSignatureVersionRequest {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetSignatureVersionRequest): GetSignatureVersionRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetSignatureVersionRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string signature = 1; */
...
class GetSignatureVersionResult$Type extends MessageType<GetSignatureVersionResult> {
    ...
    create(value?: PartialMessage<GetSignatureVersionResult>): GetSignatureVersionResult {
        const message = { version: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetSignatureVersionResult): GetSignatureVersionResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetSignatureVersionResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint64 version = 1; */
        if (message.version !== 0n)
            writer.tag(1, WireType.Varint).uint64(message.version);
        let u = options.writeUnknownFields;
...
class BytesToBase58CheckRequest$Type extends MessageType<BytesToBase58CheckRequest> {
    ...
    create(value?: PartialMessage<BytesToBase58CheckRequest>): BytesToBase58CheckRequest {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: BytesToBase58CheckRequest): BytesToBase58CheckRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: BytesToBase58CheckRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes bytes = 1; */
...
class BytesToBase58CheckResult$Type extends MessageType<BytesToBase58CheckResult> {
    ...
    create(value?: PartialMessage<BytesToBase58CheckResult>): BytesToBase58CheckResult {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: BytesToBase58CheckResult): BytesToBase58CheckResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: BytesToBase58CheckResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class Base58CheckToBytesRequest$Type extends MessageType<Base58CheckToBytesRequest> {
    ...
    create(value?: PartialMessage<Base58CheckToBytesRequest>): Base58CheckToBytesRequest {
        const message = { base58Check: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Base58CheckToBytesRequest): Base58CheckToBytesRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Base58CheckToBytesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string base58_check = 1; */
        if (message.base58Check !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.base58Check);
        let u = options.writeUnknownFields;
...
class Base58CheckToBytesResult$Type extends MessageType<Base58CheckToBytesResult> {
    ...
    create(value?: PartialMessage<Base58CheckToBytesResult>): Base58CheckToBytesResult {
        const message = { bytes: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Base58CheckToBytesResult): Base58CheckToBytesResult {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Base58CheckToBytesResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes bytes = 1; */
        if (message.bytes.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.bytes);
        let u = options.writeUnknownFields;
